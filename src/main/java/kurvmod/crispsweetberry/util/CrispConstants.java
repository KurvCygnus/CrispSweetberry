...
public class CrispConstants
{
    ...
    public static final double PROJECTILE_X_NO_SPEED = 0.0D;
    public static final double PROJECTILE_Y_NO_SPEED = 0.0D;
    public static final double PROJECTILE_Z_NO_SPEED = 0.0D;
}
