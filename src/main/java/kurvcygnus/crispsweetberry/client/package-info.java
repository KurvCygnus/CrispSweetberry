/**
 * This package contains all client-side related code.<br>
 * <b>Rendering, visual effects, UI, key bindings, and all related events, registries are all client-side elements</b>.
