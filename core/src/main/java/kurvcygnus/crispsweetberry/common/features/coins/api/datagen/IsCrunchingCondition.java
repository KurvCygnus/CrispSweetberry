...
public record IsCrunchingCondition() implements LootItemCondition
{
    ...
    @Override public @NotNull LootItemConditionType getType() { return CoinRegistries.IS_CRUNCHING_CONDITION.value(); }
    
    @Override public boolean test(@NotNull LootContext lootContext)
    {
        final var entity = lootContext.getParamOrNull(LootContextParams.THIS_ENTITY);
