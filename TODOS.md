...
<details><summary><strong>3. Crisp Sweetberry</strong></summary>
<p>

- [x] ~~Write basic **JSON configs** and **recipe**~~
- [ ] **Sprite phototype**
- [ ] **Design unique buffs**
- [ ] **Design level-spec effects**
- [ ] Extend buffs to **potions**, and add **recipes**
- [ ] Finish buffs' **icons**
- [ ] Make **undead-mob-special effect**, with an **achievement**
- [ ] **GOOD JOB XD**
- 
</p>
</details><br>

<details><summary><strong>4. Greedy Crystal</strong></summary>
<p>
